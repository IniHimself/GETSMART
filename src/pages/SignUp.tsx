...
import { BookOpen, Mail, Lock, Eye, EyeOff, ArrowRight, UserPlus } from 'lucide-react';
    ...
    <div style={{
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .signup-form-panel { padding: 2rem; }
        }
      `}</style>
        ...
        <div className="signup-form-panel">
          ...
          <form onSubmit={handleEmailSignUp}>
            ...
            <div style={{ position: 'relative', marginBottom: '1rem' }}>
              <UserPlus size={18} style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', color: 'var(--secondary-text-color)' }} />
              <input
                type="text"
                value={name}
